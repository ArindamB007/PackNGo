...
public class UserValidator implements Validator {
	...
	public void validate(Object obj, Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors,"mobile","required",vP.getSignupRequiredMobile());
		...
		if (userService.findByMobile (user.getMobile()) != null){
			errors.rejectValue("mobile", "custom",customMessages.getMessage("signup.duplicate.mobile"));
		}
